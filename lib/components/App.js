...
export default class App extends Component {
  ...
  static propTypes = {
    ...
    observeEditors: PropTypes.func.isRequired,
  ...
  renderBrowserTabs() {
    this.props.browserTabs.forEach((browserTab, index) => {
      const target = document.getElementById(browserTab.id);
      if (target) {
        const element = (
          <BrowserTab {...browserTab} index={index} />
        );
  ...
  renderBrowser() {
    return (
      <Browser browserTabs={this.props.browserTabs} />
    );
  }
